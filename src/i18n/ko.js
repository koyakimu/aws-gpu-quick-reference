export const ko = {
  ...
  calculator: {
    ...
    countLabel: "대수",
    onDemandMonthly: "On-Demand 월간 비용 (USD)",
    onDemandYearly: "On-Demand 연간 비용 (USD)",
    cbMonthly: "Capacity Blocks 월간 비용 (USD)",
    cbYearly: "Capacity Blocks 연간 비용 (USD)",
    cbOnly: "CB 전용",
    ...
    diffLabel: "차액",
    daysLabel: "일수",
    onDemandDays: "On-Demand 일수 지정 (USD)",
    cbDays: "CB 일수 지정 (USD)",
    onDemandDaysJpy: "On-Demand 일수 지정 (JPY)",
    cbDaysJpy: "CB 일수 지정 (JPY)",
