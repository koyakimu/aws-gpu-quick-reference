export const ko = {
  ...
  specs: {
    title: "GPU 사양",
    featuresTitle: "기능 매트릭스",
    unitNote: "단위는 TFLOPS (INT8 만 TOPS). — 는 NVIDIA 공식 데이터시트에 없는 항목. Dense 는 희소성 없음, Sparse 는 구조적 희소성 적용 값.",
    fp64: "FP64",
    fp64Tc: "FP64 TC",
    fp32: "FP32",
    tf32Dense: "TF32 Dense",
  ...
  placeholders: {
    specsMissing: "GPU 사양 데이터가 아직 생성되지 않았습니다.",
