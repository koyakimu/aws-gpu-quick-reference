export const ko = {
  ...
  calculator: {
    ...
    onDemandYearly: "On-Demand 연간 비용",
    cbMonthly: "Capacity Blocks 월간 비용",
    cbYearly: "Capacity Blocks 연간 비용",
    cbOnly: "CB 전용",
    exchangeRateLabel: "환율 (USD→JPY)",
    onDemandMonthlyJpy: "On-Demand 월간 비용 (JPY)",
    onDemandYearlyJpy: "On-Demand 연간 비용 (JPY)",
    cbMonthlyJpy: "CB 월간 비용 (JPY)",
    cbYearlyJpy: "CB 연간 비용 (JPY)",
    disclaimer:
