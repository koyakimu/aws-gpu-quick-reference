export const en = {
  ...
  calculator: {
    ...
    onDemandYearly: "On-Demand Yearly",
    cbMonthly: "Capacity Blocks Monthly",
    cbYearly: "Capacity Blocks Yearly",
    cbOnly: "CB Only",
    exchangeRateLabel: "Exchange Rate (USD→JPY)",
    onDemandMonthlyJpy: "On-Demand Monthly (JPY)",
    onDemandYearlyJpy: "On-Demand Yearly (JPY)",
    cbMonthlyJpy: "CB Monthly (JPY)",
    cbYearlyJpy: "CB Yearly (JPY)",
    disclaimer:
