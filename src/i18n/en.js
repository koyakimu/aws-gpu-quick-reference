export const en = {
  ...
  notes: {
    title: "Notes",
    priceNote:
      "On-Demand pricing (USD) for us-east-1 (N. Virginia). CB = Capacity Blocks (Tokyo region when available, otherwise US regions). TBD = pricing not yet announced. Updated July 2026.",
    g7eNote:
