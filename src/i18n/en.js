export const en = {
  ...
  calculator: {
    ...
    onDemandMonthly: "On-Demand Monthly (USD)",
    onDemandYearly: "On-Demand Yearly (USD)",
    cbMonthly: "Capacity Blocks Monthly (USD)",
    cbYearly: "Capacity Blocks Yearly (USD)",
    cbOnly: "CB Only",
    ...
    diffLabel: "Diff",
    daysLabel: "Days",
    onDemandDays: "On-Demand by Days (USD)",
    cbDays: "CB by Days (USD)",
    onDemandDaysJpy: "On-Demand by Days (JPY)",
    cbDaysJpy: "CB by Days (JPY)",
