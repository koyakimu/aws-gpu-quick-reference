...
export const GPU_DATA = [
    ...
    { gen: "blackwell", genRows: 8, gpu: "B300", gpuNew: true, ec2: "P6-B300", size: "p6-b300.48xlarge", count: 8, vramPerGpu: 288, fp16NonTc: null, fp16Dense: 2250, fp16Sparse: 4500, fp8Dense: 4500, fp8Sparse: 9000, fp4Dense: 14000, fp4Sparse: 28000, efa: "v4 3200G", pcie: "Gen5", vcpu: 192, mem: "4TB", nvme: "30TB", price: null, priceGpu: null, priceCb: "$11.70", tokyo: false },
    { gen: "blackwell", gpu: "B200", ec2: "P6-B200", size: "p6-b200.48xlarge", count: 8, vramPerGpu: 180, fp16NonTc: null, fp16Dense: 2250, fp16Sparse: 4500, fp8Dense: 4500, fp8Sparse: 9000, fp4Dense: 9000, fp4Sparse: 18000, efa: "v4 3200G", pcie: "Gen5", vcpu: 192, mem: "2TB", nvme: "30TB", price: null, priceGpu: null, priceCb: "$9.36", tokyo: false },
    { gen: "blackwell", gpu: "RTX PRO", gpuNew: true, gpuRows: 6, ec2: "G7e", ec2Rows: 6, size: "g7e.2xlarge", count: 1, vramPerGpu: 96, fp16NonTc: null, fp16Dense: 240, fp16Sparse: 480, fp8Dense: 480, fp8Sparse: 960, fp4Dense: null, fp4Sparse: null, efa: "-", pcie: "Gen5", vcpu: 8, mem: "64GB", nvme: "1.9TB", price: "$3.36", priceGpu: "$3.36", priceCb: "-", tokyo: false },
    { gen: "blackwell", size: "g7e.4xlarge", count: 1, vramPerGpu: 96, fp16NonTc: null, fp16Dense: 240, fp16Sparse: 480, fp8Dense: 480, fp8Sparse: 960, fp4Dense: null, fp4Sparse: null, efa: "-", pcie: "Gen5", vcpu: 16, mem: "128GB", nvme: "1.9TB", price: "$4.00", priceGpu: "$4.00", priceCb: "-", tokyo: false },
    { gen: "blackwell", size: "g7e.8xlarge", count: 1, vramPerGpu: 96, fp16NonTc: null, fp16Dense: 240, fp16Sparse: 480, fp8Dense: 480, fp8Sparse: 960, fp4Dense: null, fp4Sparse: null, efa: "-", pcie: "Gen5", vcpu: 32, mem: "256GB", nvme: "1.9TB", price: "$5.27", priceGpu: "$5.27", priceCb: "-", tokyo: false },
    { gen: "blackwell", size: "g7e.12xlarge", count: 2, vramPerGpu: 96, fp16NonTc: null, fp16Dense: 240, fp16Sparse: 480, fp8Dense: 480, fp8Sparse: 960, fp4Dense: null, fp4Sparse: null, efa: "-", pcie: "Gen5", vcpu: 48, mem: "512GB", nvme: "3.8TB", price: "$8.29", priceGpu: "$4.14", priceCb: "-", tokyo: false },
    { gen: "blackwell", size: "g7e.24xlarge", count: 4, vramPerGpu: 96, fp16NonTc: null, fp16Dense: 240, fp16Sparse: 480, fp8Dense: 480, fp8Sparse: 960, fp4Dense: null, fp4Sparse: null, efa: "-", pcie: "Gen5", vcpu: 96, mem: "1TB", nvme: "7.6TB", price: "$16.57", priceGpu: "$4.14", priceCb: "-", tokyo: false },
    { gen: "blackwell", size: "g7e.48xlarge", count: 8, vramPerGpu: 96, fp16NonTc: null, fp16Dense: 240, fp16Sparse: 480, fp8Dense: 480, fp8Sparse: 960, fp4Dense: null, fp4Sparse: null, efa: "-", pcie: "Gen5", vcpu: 192, mem: "2TB", nvme: "15.2TB", price: "$33.14", priceGpu: "$4.14", priceCb: "-", tokyo: false },
    // Hopper (fp16/fp8 values with sparsity; dense = sparse / 2)
    { gen: "hopper", genRows: 4, gpu: "H200", ec2: "P5en", size: "p5en.48xlarge", count: 8, vramPerGpu: 141, fp16NonTc: null, fp16Dense: 989, fp16Sparse: 1979, fp8Dense: 1979, fp8Sparse: 3958, fp4Dense: null, fp4Sparse: null, efa: "v3 3200G", pcie: "Gen5", vcpu: 192, mem: "2TB", nvme: "30TB", price: "$63.30", priceGpu: "$7.91", priceCb: "$5.20", tokyo: true },
    { gen: "hopper", gpu: "H200", ec2: "P5e", size: "p5e.48xlarge", count: 8, vramPerGpu: 141, fp16NonTc: null, fp16Dense: 989, fp16Sparse: 1979, fp8Dense: 1979, fp8Sparse: 3958, fp4Dense: null, fp4Sparse: null, efa: "v2 3200G", pcie: "Gen4", vcpu: 192, mem: "2TB", nvme: "30TB", price: null, priceGpu: null, priceCb: "$4.98", tokyo: true },
    { gen: "hopper", gpu: "H100", gpuRows: 2, ec2: "P5", ec2Rows: 2, size: "p5.48xlarge", count: 8, vramPerGpu: 80, fp16NonTc: null, fp16Dense: 989, fp16Sparse: 1979, fp8Dense: 1979, fp8Sparse: 3958, fp4Dense: null, fp4Sparse: null, efa: "v2 3200G", pcie: "Gen4", vcpu: 192, mem: "2TB", nvme: "30TB", price: "$30.27", priceGpu: "$3.78", priceCb: "$3.93", tokyo: true },
    { gen: "hopper", size: "p5.4xlarge", count: 1, vramPerGpu: 80, fp16NonTc: null, fp16Dense: 989, fp16Sparse: 1979, fp8Dense: 1979, fp8Sparse: 3958, fp4Dense: null, fp4Sparse: null, efa: "-", pcie: "Gen4", vcpu: 24, mem: "256GB", nvme: "3.8TB", price: "$3.78", priceGpu: "$3.78", priceCb: "$3.78", tokyo: true },
    ...
    { gen: "ampere", genRows: 9, gpu: "A100 40GB", ec2: "P4d", size: "p4d.24xlarge", count: 8, vramPerGpu: 40, fp16NonTc: 78, fp16Dense: 156, fp16Sparse: 312, fp8Dense: null, fp8Sparse: null, fp4Dense: null, fp4Sparse: null, efa: "v1 400G", pcie: "Gen4", vcpu: 96, mem: "1.1TB", nvme: "8TB", price: "$14.71", priceGpu: "$1.84", priceCb: "$1.48", tokyo: true },
    { gen: "ampere", gpu: "A100 80GB", ec2: "P4de", size: "p4de.24xlarge", count: 8, vramPerGpu: 80, fp16NonTc: 78, fp16Dense: 156, fp16Sparse: 312, fp8Dense: null, fp8Sparse: null, fp4Dense: null, fp4Sparse: null, efa: "v1 400G", pcie: "Gen4", vcpu: 96, mem: "1.1TB", nvme: "8TB", price: "$18.40", priceGpu: "$2.30", priceCb: "$1.85", tokyo: false },
